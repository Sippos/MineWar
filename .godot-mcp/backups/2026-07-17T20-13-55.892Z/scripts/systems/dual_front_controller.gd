...
func _setup() -> void:
	...
	# The previous world process owns the old random-wave timer. Mining, combat,
	# pickups, abilities, and the base are separate nodes and keep running while
	# this controller owns the new maze/portal invasion rhythm.
