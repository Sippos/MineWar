...
func _process(delta: float) -> void:
	# The custom Adventure and LineWars controllers own all threat timing. Even if
	# another system temporarily enables this node, never run the inherited wave
	# director without a standard MineWars wave number.
