...
func _begin_build_phase() -> void:
	...
	instruction_label.text = "Dig side routes, close shortcuts only after reconnecting, choose attack pressure, then ready both lanes."
...
func _on_start_wave_pressed() -> void:
	...
	var enemy_health := 10.0 + float(current_wave) * 2.4
