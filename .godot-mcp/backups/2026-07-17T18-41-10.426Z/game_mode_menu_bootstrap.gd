...
func _on_node_added(_node: Node) -> void:
	# Scene changes can free a newly-added node before a deferred callback runs.
	# Rescan the live tree instead of retaining that stale reference.
	call_deferred("_scan_tree")
