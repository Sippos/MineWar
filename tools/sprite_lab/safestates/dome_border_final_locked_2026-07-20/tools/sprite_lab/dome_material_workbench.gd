...
func _export_runtime_assets() -> void:
	...
	_save_sources()
	status_label.text = "Exported four border atlases plus four independently editable pixel-aligned Hole Corner atlases." if result == OK else "Runtime export failed: %s" % error_string(result)
