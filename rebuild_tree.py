...
[node name="RootIconContainer" type="CenterContainer" parent="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch"]
layout_mode = 2

[node name="RootIcon" type="TextureRect" parent="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/RootIconContainer"]
layout_mode = 2
texture = ExtResource("4_healthbar")
stretch_mode = 5

[node name="TreeBranches" type="GridContainer" parent="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch"]
layout_mode = 2
size_flags_vertical = 3
columns = 2
...
[node name="UnlockHealthbar" type="Button" parent="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches"]
layout_mode = 2
size_flags_horizontal = 3
text = "Player HP (10 Gold)"

[node name="UnlockBaseHealth" type="Button" parent="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches"]
layout_mode = 2
size_flags_horizontal = 3
text = "Base HP (10 Gold)"

[node name="UnlockWaveTimer" type="Button" parent="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches"]
layout_mode = 2
size_flags_horizontal = 3
text = "Wave Timer (10 Gold)"

[node name="UnlockXP" type="Button" parent="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches"]
layout_mode = 2
size_flags_horizontal = 3
text = "XP Bar (10 Gold)"

[node name="UnlockStats" type="Button" parent="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches"]
layout_mode = 2
size_flags_horizontal = 3
text = "Show Stats (10 Gold)"

[node name="UnlockMinimap" type="Button" parent="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches"]
layout_mode = 2
size_flags_horizontal = 3
text = "Unlock Minimap (20 Gold)"

[node name="UpgradeMinimap" type="Button" parent="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches"]
layout_mode = 2
size_flags_horizontal = 3
text = "Mini: Enemies (50 G)"
...
[connection signal="pressed" from="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches/UnlockHealthbar" to="." method="_on_unlock_healthbar_pressed"]
[connection signal="pressed" from="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches/UnlockBaseHealth" to="." method="_on_unlock_base_health_pressed"]
[connection signal="pressed" from="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches/UnlockStats" to="." method="_on_unlock_stats_pressed"]
[connection signal="pressed" from="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches/UnlockWaveTimer" to="." method="_on_unlock_wave_timer_pressed"]
[connection signal="pressed" from="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches/UnlockXP" to="." method="_on_unlock_xp_pressed"]
[connection signal="pressed" from="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches/UnlockMinimap" to="." method="_on_unlock_minimap_pressed"]
[connection signal="pressed" from="Panel/VBoxContainer/MainContent/TopSection/HUD_Branch/TreeBranches/UpgradeMinimap" to="." method="_on_upgrade_minimap_pressed"]
