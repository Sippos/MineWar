...
func _run_smoke_test() -> void:
	...
	# Radar remains infrastructure: it costs banked gold and grants warning
	# information instead of passive combat damage.
	var world_hud := world.get_node("HUD")
	world_hud.set("total_gold", 20)
	...
	_expect(int(world_hud.get("total_gold")) == 10, "Radar infrastructure should spend exactly ten banked gold")
